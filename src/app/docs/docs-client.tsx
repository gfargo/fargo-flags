              ...
              <div className="grid gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Installs <code>&lt;Flag&gt;</code> conal rendering
                    component
                  </p>
                </div>
                  ...
                  <div className="bg-primary/10 border border-primary/20 p-4 rounded-lg text-sm mb-4">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      ...
                      <li>
                        ...
                        <code>defaultValue</code> if <code>decide()</code> is
                        not provided
                      </li>
                    </ul>
                  </div>
...
// 3. Return the resolved value`}
                  ...
                  <p className="text-muted-foreground mb-3">
                    This function creates a client-safe subset by filtering
                    flags based on their <code>client.public</code> setting:
                  </p>
      ...
      <body>
        <FlagsProvider flags={clientFlags}>
          {children}
                  ...
                  <p className="text-muted-foreground mb-3">
                    Use the <code>serialize</code> option to transform flag
                    values before sending to the client:
                  </p>
          ...
          <FlagsProvider flags={{} as any}>
            {children}
                  ...
                  <div className="bg-primary/5 border border-primary/10 p-4 rounded-lg text-sm">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        <strong>Cache context functions:</strong> Use
                        React&apos;s <code>cache()</code> to avoid duplicate
                        user/workspace fetches
                      </li>
                      <li>
                        <strong>Keep decide() functions fast:</strong> They run
                        on every request - avoid expensive operations
                      </li>
                      <li>
                        <strong>Minimize client flags:</strong> Only expose
                        flags that components actually need
                      </li>
                      <li>
...
function TypeSafeExample() {
  ...
  return <div className={theme === "dark" ? "dark" : "light"}>Content</div>;
                  ...
                  <div className="bg-primary/10 border border-primary/20 p-4 rounded-lg text-sm">
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        Use descriptive variable names that match the flag
                        purpose
                      </li>
                      <li>
                  ...
                  <div className="bg-muted p-4 rounded-lg text-sm mb-4">
                    <ul className="space-y-2">
                      ...
                      <li>
                        ...
                        <code>any</code> - Render children when flag value
                        equals this
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <code>ReactNode</code> - Content to show when condition
                        is false
                      </li>
                      <li>
                        <code className="text-primary">children</code>:{" "}
          ...
          <Content />
                  ...
                  <div className="bg-primary/5 border border-primary/10 p-4 rounded-lg text-sm">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      ...
                      <li>
                        Prefer <code>&lt;Flag&gt;</code> over conditional JSX
  ...
  : YourApp;`}
                  ...
                  <div className="bg-primary/5 border border-primary/10 p-4 rounded-lg text-sm">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      ...
                      <li>
                        Create separate test cases for different flag
                        combinations
                      </li>
                      <li>
    ...
    "flags:check": "tsx scripts/check-flags-registry.ts"
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="p-3 border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    The fallback value when no <code>decide()</code> function is
                    provided or when it returns undefined.
                  </p>
                </div>
              </div>
                ...
                {`# package.json
{
  "lint-staged": {
    "src/lib/flags/**/*.ts": ["pnpm flags:check"]
              ...
              <p className="text-muted-foreground mb-3">
                You can modify <code>scripts/create-flag.ts</code> to customize
                the generated flag templates:
              </p>
              <pre className="bg-muted p-4 rounded-lg text-sm mb-4">
                {`// Add custom prompts
...
// Generate flag usage reports`}
              ...
              <p className="text-muted-foreground mb-3">
                After installation, add these scripts to your{" "}
                <code>package.json</code>:
              </p>
              <pre className="bg-muted p-4 rounded-lg text-sm mb-6">
                {`{
  ...
  "devDependencies": {
    ...
    "prettier": "^3.6.2"
              ...
              <p className="text-muted-foreground mb-3">
                Interactive wizard that creates a new flag file and updates the
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4">
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Flag Key:</strong> Enter kebab-case flag
                      identifier (e.g., &quot;enable-new-dashboard&quot;)
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="bg-primary/20 text-primary px-2 py-1 rounded text-xs font-medium">
                    ...
                    <span>
                      <strong>Value Type:</strong> Choose between boolean or
                      string enum
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Enum Options:</strong> If enum, specify
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Client Exposure:</strong> Choose if flag should be
                      available on client
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Serializer:</strong> Optional function to
                      transform values for client
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="bg-primary/20 text-primary px-2 py-1 rounded text-xs font-medium">
                    ...
                    <span>
                      <strong>Default Value:</strong> Set the fallback value
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="bg-primary/20 text-primary px-2 py-1 rounded text-xs font-medium">
                    ...
                    <span>
                      <strong>Description:</strong> Optional human-readable
                      description
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-primary/5 border border-primary/10 p-4 rounded-lg mb-6">
                <ul className="text-sm space-y-1">
                  <li>
                    ✅ Creates flag file in <code>src/lib/flags/defs/</code>
                  </li>
                  <li>
                    ✅ Updates <code>registry.config.ts</code> with imports and
                    entries
                  </li>
                  <li>
                    ✅ Adds to <code>clientFlagKeys</code> if public
                  </li>
              ...
              <p className="text-muted-foreground mb-3">
                Validates that all flag definitions are properly registered and
                consistent. Essential for CI/CD pipelines and team development.
              </p>
              ...
              <div className="bg-primary/5 border border-primary/10 p-4 rounded-lg mb-4">
                <ul className="text-sm space-y-1">
                  <li>
                    🔍 Every <code>defs/*.flag.ts</code> file is imported in{" "}
                    <code>registry.config.ts</code>
                  </li>
                  <li>
                    🔍 All imports have corresponding entries in{" "}
                    <code>flagSchemas</code> and <code>registry</code>
                  </li>
                  <li>
                    🔍 <code>flagSchemas</code> keys match <code>registry</code>{" "}
                    keys exactly
                  </li>
                  <li>
                    🔍 <code>clientFlagKeys</code> aligns with each flag&apos;s{" "}
                    <code>client.public</code> setting
                  </li>
                  <li>
                    🔍 No orphaned registry entries without corresponding flag
                    files
                  </li>
  ...
  test:
    ...
    steps:
      ...
      - run: pnpm test`}
              ...
              <p className="text-muted-foreground mb-3">
                You can also create flags manually without the wizard. The
